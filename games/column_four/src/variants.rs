...
impl Variant {
    pub fn column_four_standard() -> Self {
        Self {
            ...
            board_columns: 7,
            board_rows: 6,
            cell_id_scheme: "r1c1_to_r6c7_bottom_to_top".to_owned(),
            ending: "four_line_win_or_full_board_draw".to_owned(),
        }
    }
}
...
mod tests {
    ...
    fn constants_match_static_data() {
        ...
        assert_eq!(manifest.game_id, crate::ids::GAME_ID);
        ...
        assert_eq!(variants.selected, Variant::column_four_standard());
    }
}
