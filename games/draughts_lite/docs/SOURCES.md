...
| Rulepath Gate 7 spec | `../../../../specs/gate-7-draughts-lite-compound-action-tree.md` | 2026-06-07 | project authority | product scope and evidence requirements | none | Governs `draughts_lite` identity, rule scope, docs, tests, replay, bot, WASM, UI, benchmark, primitive-pressure, and archive obligations. |
