...
use crate::ids::RULES_VERSION_LABEL;
...
impl Manifest {
    pub fn parse(input: &str) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            disc_name: required_string(&values, "disc_name")?,
...
impl Variant {
    pub fn directional_flip_standard() -> Self {
        Self {
            ...
            opening: "seat_0:r4c5,r5c4;seat_1:r4c4,r5c5".to_owned(),
            ending: "no_legal_placement_double_forced_pass_or_no_continuation".to_owned(),
        }
    }
}
