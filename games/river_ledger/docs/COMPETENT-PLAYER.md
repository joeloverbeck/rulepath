...
Rules version checked: `river-ledger-rules-v1`
...
- call affordable prices to preserve showdown access;
...
| Showdown/foldout | Terminal allocation and explanation are Rust-authored. | single pot, split/remainder | Foldout reveals no folded private cards; showdown reveal is handled by Rust outcome records. |
