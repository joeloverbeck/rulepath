...
|---|---|---|---|---|---|---|---|
| `SC-SPEC` | Rulepath Gate 20 Starbridge Crossing spec | `../../../specs/gate-20-starbridge-crossing-star-halma.md` | 2026-06-27 | project authority | product scope, locked variant, rule IDs, source tags, seat counts, docs, tests, replay, bot, WASM, UI, benchmark, and capstone obligations | none | Active gate authority for this ticket series. |
