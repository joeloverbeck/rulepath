...
pub const TURN_REPORT_AUDIT: &str =
    "Not adopted by ACTCONMAT-006; Masked Claims reaction narration is outside this ticket.";
...
pub fn catalog_theme() -> CatalogThemeMetadata {
    CatalogThemeMetadata {
        icon_id: "masked_claims",
        theme_key: "masked-claims",
        accent_token: "--game-accent",
        secondary_accent_token: "--game-accent-2",
        shape_token: "abstract-claim-visor",
        accessibility_label: "Masked Claims abstract claim visor",
    }
}
