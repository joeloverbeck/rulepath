use engine_core::{HashValue, SeatId, StableSerialize, Viewer, VisibilityScope};
...
#[test]
fn setup_evidence_v1_profile_driver_wraps_deck_fixture_metadata() {
    let fixture = include_str!("../data/fixtures/poker_lite_standard.fixture.json");
    assert!(fixture.contains("\"fixture_id\": \"poker_lite_standard_gate10\""));
    assert!(fixture.contains("\"game_id\": \"poker_lite\""));
    assert!(fixture.contains("\"variant\": \"poker_lite_standard\""));
    assert!(fixture.contains("\"rules_version\": \"poker-lite-rules-v1\""));
    assert!(fixture.contains("\"deck_order\""));
    assert!(fixture.contains("\"private_cards\": \"hidden_by_setup\""));
    assert!(fixture.contains("\"center_status\": \"hidden\""));
    assert!(!fixture.contains("seat_0_private"));
    assert!(!fixture.contains("seat_1_private"));
    assert!(!fixture.contains("private_hand"));

    let driver = SetupEvidenceV1Driver::new("poker_lite");
