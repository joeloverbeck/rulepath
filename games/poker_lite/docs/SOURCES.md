...
|---|---|---|---|---|---|---|
| Rulepath Gate 10 poker_lite betting / showdown spec | `../../../specs/gate-10-poker-lite-betting-showdown.md` | 2026-06-09 | project authority | product scope, rule identity, neutral naming, hidden-card setup, pledge rounds, shared-pool accounting, no-leak, docs, tests, replay, bot, WASM, UI, benchmark, and capstone obligations | none | Governs this game's implementation tickets and acceptance evidence. |
