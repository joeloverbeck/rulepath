...
fn resolve_game(game: &str) -> Result<RegisteredGame, String> {
    match game {
        ...
        "flood_watch" => Ok(RegisteredGame {
            game_id: "flood_watch",
            rules_path: "games/flood_watch/docs/RULES.md",
            coverage_path: "games/flood_watch/docs/RULE-COVERAGE.md",
        ...
        "river_ledger" => Ok(RegisteredGame {
            ...
            rules_path: "games/river_ledger/docs/RULES.md",
            coverage_path: "games/river_ledger/docs/RULE-COVERAGE.md",
        ...
        "vow_tide" => Ok(RegisteredGame {
            game_id: "vow_tide",
            rules_path: "games/vow_tide/docs/RULES.md",
            coverage_path: "games/vow_tide/docs/RULE-COVERAGE.md",
        ...
        "meldfall_ledger" => Ok(RegisteredGame {
            ...
            rules_path: "games/meldfall_ledger/docs/RULES.md",
            coverage_path: "games/meldfall_ledger/docs/RULE-COVERAGE.md",
...
"#;
    ...
    fn draughts_lite_rule_prefix_is_valid() {
        ...
        assert!(is_rule_id("RL-SETUP-SEATS-001"));
        assert!(is_rule_id("RL-EVAL-001"));
        assert!(is_rule_id("VT-BID-ORDER-001"));
        assert!(is_rule_id("VT-VIEW-001"));
        assert!(!is_rule_id("RL-SETUP-SEATS-ABC"));
