...
6. **Testing / verification** — how to confirm it works (unit, rule, golden trace, property, simulation, replay, serialization, visibility/no-leak, bot legality, UI smoke, benchmark — per `docs/TESTING-AND-BENCHMARKING.md`)
