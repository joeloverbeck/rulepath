...
Carve-out: when the user's initial request pre-authorizes a deliverable contingent on the brainstorm's verdict (e.g. "write an ADR if changes are warranted"), presenting the design or triage recommendation IS the approval that satisfies this gate — see Guardrails §User pre-authorization. The Step 6 menu still fires afterward.
</HARD-GATE>
