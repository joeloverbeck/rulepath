...
| Implementation work item (agent-task ticket) | filled `tickets/_TEMPLATE.md` → `tickets/<PREFIX>-NNN.md` (decomposing a spec: `/reassess-spec` then `/spec-to-tickets`) |
