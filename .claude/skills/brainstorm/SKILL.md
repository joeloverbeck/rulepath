...
| ADR / agent task / triage / proposal — or any deliverable whose options describe NEXT phases (decompose / implement / done) | **Menu MANDATORY**, even when written this same turn — writing the file is pre-implementation, and skipping the menu strips the user's named next-phase options |
