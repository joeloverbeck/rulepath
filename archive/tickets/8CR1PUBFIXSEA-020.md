...
- `games/three_marks/src/setup.rs::setup_match` now validates the fixed two-seat range with `SeatCountRange::inclusive(...).validate(...)`.
...
- The typed `ThreeMarksSeat::other()` mapping and setup ordering/state construction were left unchanged.
