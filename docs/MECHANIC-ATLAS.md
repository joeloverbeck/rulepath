...
Current debt: _None_. Last reviewed during Gate 18 Blackglass Pact closeout on
2026-06-25; the `game-stdlib::trick_taking` helper promotion conformed Plain
Tricks and Briar Circuit in-gate, Vow Tide uses the helper, Blackglass Pact
reuses it unchanged, and no open promotion debt remains.
