...
Current debt: _None_. Last reviewed during Gate 19 Meldfall Ledger closeout on
2026-06-26; the `game-stdlib::trick_taking` helper promotion remains conformed,
Meldfall Ledger adds only first-use local rummy-family mechanics, and no open
promotion debt remains.
