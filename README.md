...
**Gates 0-12 complete; Gate 13 Frontier Control in progress** — Rulepath now ships thirteen local-playable
...
accepted cooperative event-pressure proof. Gate 13 is executing the asymmetric
graph-map area-control proof.
