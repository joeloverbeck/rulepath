...
use crate::seats::{
    canonical_seats_for_count, canonical_trace_seat_id, parse_directional_seat, seats,
};
...
pub(crate) fn directional_replay_document_json(
    ...
    let commands_json = commands
        .iter()
        .enumerate()
        .map(|(index, command)| directional_command_record_json(index, command))
...
fn directional_command_record_json(
    index: usize,
