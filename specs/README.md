...
| 11.2 | Gate 20.2 — Starbridge Crossing discontinuous active-seat setup labels | [`gate-20-2-starbridge-crossing-active-seat-setup-labels.md`](gate-20-2-starbridge-crossing-active-seat-setup-labels.md) | Planned | Spec written 2026-06-27. Presentation/contract follow-on on shipped Gate 20: the browser setup screen mislabels active seats for 2/3/4-seat matches because the shared web shell slices the first *N* of the catalog six-point ring instead of consuming a Rust-owned active-seat-by-count mapping (`active_points_for_seat_count` / `SC-SETUP-003`). Adds additive Rust catalog metadata and makes the shell present it; presentation-only, no accepted-command/state/effect/view/hash change. Independent of Gate 21. |
