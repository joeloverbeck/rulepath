...
| 8F | Pre-Gate-18 — forward scaffolding-reuse governance | [`pre-gate-18-forward-scaffolding-reuse-governance.md`](pre-gate-18-forward-scaffolding-reuse-governance.md) | Done | Completed 2026-06-25. Append-only ADR 0008 extension plus authority-ordered workflow/template/register/CI amendments landed a standing per-new-game reuse-first audit, register-new on first use, and queue-or-dispose prior-game refactor obligation. Governance only: no game/helper/trace/fixture/hash/visibility migration. Gate 18 remains `Not started` and becomes the first `forward-v1` audit user. |
