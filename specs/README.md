...
| 7 | Gate 16 — Hearts | [`gate-16-briar-circuit-trick-taking.md`](gate-16-briar-circuit-trick-taking.md) | Done | Completed 2026-06-21. Briar Circuit fixed-four-seat trick-taking, no-leak/replay/web/bench evidence, and keep-local/defer trick-taking evaluation closed. |
