...
| 8C-R2 | C-11 follow-on — two-seat hidden/reaction scaffolding | [`unit-8c-r2-two-seat-hidden-reaction-scaffolding-intermediate-spec.md`](unit-8c-r2-two-seat-hidden-reaction-scaffolding-intermediate-spec.md) | Done | Completed 2026-06-23. High Card Duel residual audit plus Secret Draft, Poker Lite, and Masked Claims closed C-01...C-10 with register/report receipts, no behavior promotion, no unauthorized golden/fixture diffs, full §7 evidence, and explicit N/A/exception rows for non-applicable profile/RNG surfaces. `8C-R3`, `8C-R4`, and Gate 18 remain pending. |
