...
| — | Non-gate (River Ledger correctness) — showdown and active-seat presentation fixes | [`river-ledger-showdown-and-seat-presentation-fixes.md`](river-ledger-showdown-and-seat-presentation-fixes.md) | Done | Completed 2026-06-18. RIVLEDSHOSEA-001..010 fixed canonical winner/remainder order, one-based public seat labels, single resolved-showdown assembly, golden trace/replay evidence, active-match seat projection, generic viewer selector behavior, setup seat copy, cross-catalog no-leak/selector coverage, River Ledger card containment, and docs/status reconciliation. |
