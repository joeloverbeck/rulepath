...
| 8C | Mechanical-scaffolding code extraction (Part C) | [`unit-8c-mechanical-scaffolding-code-extraction.md`](unit-8c-mechanical-scaffolding-code-extraction.md) | Planned | Shared mechanical-scaffolding C-01...C-10 plus the dev-only `game-test-support` crate and bounded pilots; remaining C-11 retrofits are seeded forward before Gate 18. All hash/visibility migration is governed by ADR 0009; no blanket golden regeneration. |
