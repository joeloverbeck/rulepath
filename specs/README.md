...
| 9 | Gate 10 | [`poker_lite` / Crest Ledger betting-showdown proof](gate-10-poker-lite-betting-showdown.md) complete; `plain_tricks` trick/follow-suit proof not yet specced | In progress |
