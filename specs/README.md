...
| 8C-R1 | C-11 follow-on — public/fixed-seat scaffolding | _(seed; unwritten)_ | Not started | Games: `race_to_n` residual audit, `draughts_lite` residual audit, `three_marks`, `column_four`, `directional_flip`, `token_bazaar`. Audit applicable helpers C-01...C-05/C-08; hash/visibility obligations follow ADR 0009 per touched surface; rollback is one surface per diff or an accepted not-applicable/exception. Admission/exit: audit residual pilots only for unapplied helpers/surfaces; migrate one surface per diff or record accepted not-applicable/exception. |
| 8C-R2 | C-11 follow-on — two-seat hidden/reaction scaffolding | _(seed; unwritten)_ | Not started | Games: `high_card_duel` residual audit, `secret_draft`, `poker_lite`, `masked_claims`. Audit applicable helpers C-01...C-08, especially private effects/views, replay/export, and no-leak geometry; hash/visibility obligations follow ADR 0009 and ADR 0004 evidence; rollback is one surface per diff or an accepted not-applicable/exception. Admission/exit: adopt scaffolding without moving reveal/reaction policy; High Card's 8C pilot discharges only its named no-leak surface. |
| 8C-R3 | C-11 follow-on — public/co-op/asymmetric/trick support | _(seed; unwritten)_ | Not started | Games: `plain_tricks`, `flood_watch`, `frontier_control`, `event_frontier`. Audit applicable helpers C-01...C-08 for setup/profile diversity, action-tree/effect hashing, and fixture/profile surfaces; hash/visibility obligations follow ADR 0009 per touched surface; rollback is one surface per diff or an accepted not-applicable/exception. Admission/exit: preserve behavioral atlas decisions and do not promote trick, graph, event, budget, or scoring policy. |
| 8C-R4 | C-11 follow-on — N-seat/private/trick support | _(seed; unwritten)_ | Not started | Games: `river_ledger` residual audit, `briar_circuit`, `vow_tide`. Audit applicable helpers C-01...C-08 plus seat/profile/no-leak matrices; hash/visibility obligations follow ADR 0009 per touched surface, and any RNG algorithm migration is separately versioned; rollback is one surface per diff or an accepted not-applicable/exception. Admission/exit: River/Vow/Briar 8C pilots discharge only their named surfaces. |
