...
| 11 | Gate 11 | [`gate-11-masked-claims-bluff-reaction-proof.md`](gate-11-masked-claims-bluff-reaction-proof.md) (`masked_claims` / Masked Claims; claim/challenge reaction-window, pending-response, and conditional-resolution proof; carries the fourth-use shuffle/private-hand ledger reopen as pre-implementation work) | Planned |
