...
| 13 | Gate 13 | [`gate-13-frontier-control-asymmetric-area-control-proof.md`](gate-13-frontier-control-asymmetric-area-control-proof.md) (`frontier_control` / Frontier Control; asymmetric graph-map area-control proof: graph topology, site control, faction-asymmetric actions and scoring, per-faction UI and bots; carries pre-implementation atlas reviews for the board_space audit, role-modifier and multi-action-budget second uses, and the shared-outcome and reaction-window comparison rows) | Planned |
