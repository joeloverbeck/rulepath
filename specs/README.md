...
| 8F | Pre-Gate-18 — forward scaffolding-reuse governance | [`pre-gate-18-forward-scaffolding-reuse-governance.md`](pre-gate-18-forward-scaffolding-reuse-governance.md) | Planned | Blocking interlock before Gate 18. Seeded from [`../reports/forward-scaffolding-reuse-governance-change-plan.md`](../reports/forward-scaffolding-reuse-governance-change-plan.md); run `/reassess-spec` in place before decomposition. Append-only ADR 0008 extension + authority-ordered workflow/template/register/CI amendments requiring a per-new-game reuse-first audit, register-new on first use, and queue-or-dispose prior-game refactors. Governance only: no game/helper/trace/fixture/hash/visibility migration. |
