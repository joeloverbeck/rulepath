...
| 11.1 | Gate 20.1 — Starbridge Crossing hop-chain origin-return prohibition | [`gate-20-1-starbridge-crossing-hop-chain-origin-return-prohibition.md`](gate-20-1-starbridge-crossing-hop-chain-origin-return-prohibition.md) | Planned | Authored 2026-06-27. Correctness follow-on on shipped Gate 20: a hop chain can land back on the moving peg's own origin space, committing a net-zero no-op turn (back-door voluntary pass) that violates `SC-TURN-002` / `SC-MOVE-009`. Needs `SC-MOVE-007` rule-text clarification + ADR-0009-governed action-tree-hash/golden-trace migration. Independent of Gate 21. |
