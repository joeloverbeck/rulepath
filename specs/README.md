...
| 9 | Gate 10 | [`poker_lite` / Crest Ledger betting-showdown proof](../archive/specs/gate-10-poker-lite-betting-showdown.md) complete; trick/follow-suit half owned by Gate 10.1 below | In progress |
| 10 | Gate 10.1 | [`gate-10-1-plain-tricks-trick-taking-proof.md`](gate-10-1-plain-tricks-trick-taking-proof.md) (`plain_tricks` / Plain Tricks; lead/follow legality, trick resolution, round scoring, deal rotation; carries the third-use card/private-hand ledger hard gate; closes the remaining Gate 10 trick rows) | Planned |
